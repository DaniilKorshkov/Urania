...
st.write("Use Error Codes page to inspect meanings of error codes")
...
st.write("Use VSC controls to manually control vacuum control system and multi-inlet valve")
st.write("Use actuator controls to manually control filling station actuators")
st.write("Use filling tracker to inspect filled volume")
st.write("Use VSC Log page to inspect pressure and mass flow data collected by VSC")
st.write("Use Notification Settings page to change notification options for every of the error codes")
